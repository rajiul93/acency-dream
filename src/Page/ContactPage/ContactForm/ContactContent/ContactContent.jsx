    ...
    <div className="md:p-4">
      ...
      <div className="flex gap-4">
        <div className="avatar">
          <div className=" md:w-10 h-10 text-info px-4  pt-2 rounded-full bg-base-100 ">1</div>
        </div>
        <h1 className="text-sm text-start"><b>Consultation:</b> We schedule a meeting to discuss about your needs. </h1 >
      </div>
      <div className="divider bg-warning flex  flex-col hidden lg:block h-3 w-[.5px] ms-5 my-0"></div>
      <div className="flex gap-4">
        <div className="avatar">
          <div className=" md:w-10 h-10 text-info px-4 pt-2 rounded-full bg-base-100 ">2</div>
        </div>
      ...
      <div className="flex gap-4">
        <div className="avatar">
          <div className=" md:w-10 h-10 text-info px-4 pt-2 rounded-full bg-base-100 ">3</div>
        </div>
