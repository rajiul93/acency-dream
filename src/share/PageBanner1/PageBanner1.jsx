    ...
    <div className="hero card-font min-h-[50vh] bg-gradient-to-b from-[#d1fae5] to-base-100">
      <div className="hero-content max-w-6xl mx-auto flex-col lg:flex-row-reverse">
        ...
        <div className="lg:w-2/3">
          ...
          <p className="py-6 font-normal text-neutral lg:text-[18px]">
            {content}
          </p>
          <Link
            to="/contact"
            className="bg-info shadow-xl about-font px-8 hover:bg-accent duration-500 py-3 lg:mt-6 rounded-xl text-xl text-base-100"
          >
           {` Let's Get Started`}
          </Link>
        </div>
