...
const HeroButton = () => {
  return (
    <Link
      to="/contact"
      className="relative px-3 lg:px-10 py-3  w-52 md:w-1/2 cursor-pointer font-medium
       text-white transition duration-300 bg-info rounded-lg hover:shadow-2xl ease"
    >
